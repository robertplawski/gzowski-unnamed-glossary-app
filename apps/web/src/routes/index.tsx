        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-muted p-8 rounded-2xl border border-border hover:shadow-md transition-shadow">
              ...
              <div>
                <div className="font-bold text-foreground">Dawid S.</div>
            ...
            <div className="bg-muted p-8 rounded-2xl border border-border hover:shadow-md transition-shadow">
              <div className="text-5xl text-primary/30 mb-4">"</div>
              <p className="text-lg italic text-foreground mb-6">
                "As a non-native speaker preparing for exams, GUGA's clear
                explanations gave me confidence I never had with traditional
                dictionaries."
              </p>
              <div>
                <div className="font-bold text-foreground">Karol S.</div>
            ...
            <div className="bg-muted p-8 rounded-2xl border border-border hover:shadow-md transition-shadow">
              ...
              <div>
                <div className="font-bold text-foreground">Robert P.</div>
                <div className="text-muted-foreground">Technical student</div>
              </div>
            </div>
          </div>
        </div>
